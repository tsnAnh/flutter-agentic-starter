...
* The project is a production-ready Flutter BLoC starter template with Clean Architecture, GetIt/Injectable DI, GoRouter, Dio, Hive, Firebase/PostHog facades, Material 3, and agent-ready rules.
* `lib/features/home` is the concrete feature template.
